...
import com.shocktrade.javascript.models.contest.{Contest, Perk}
...
class PerksDialogController($scope: PerksDialogScope, $modalInstance: ModalInstance[PerksDialogResult], toaster: Toaster,
  ...
  private var myFunds: js.UndefOr[Double] = mySession.cashAccount_?.orUndefined.flatMap(_.cashFunds)
