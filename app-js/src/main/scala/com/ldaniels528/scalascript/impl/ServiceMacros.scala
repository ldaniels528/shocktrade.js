...
protected [scalascript] class ServiceMacros(val c: blackbox.Context) extends MacroBase {
  import c.universe._

  // print generated code to console during compilation
  private lazy val logCode = c.settings.contains("com.ldaniels528.scalascript.ServiceMacros.debug")
