(function () {
     ...
     */
    app.controller('MainController', ['$scope', '$http', '$interval', '$location', '$log', '$timeout', 'toaster', 'ContestService', 'Facebook', 'FavoriteSymbols', 'HeldSecurities', 'MySession', 'ProfileService', 'RecentSymbols', 'SignUpDialog',
        function ($scope, $http, $interval, $location, $log, $timeout, toaster, ContestService, Facebook, FavoriteSymbols, HeldSecurities, MySession, ProfileService, RecentSymbols, SignUpDialog) {
