...
(function () {
    angular.module('shocktrade')
        .factory('WebSockets', function ($rootScope, $location, $log) {
            var service = {};
            ...
            function handleMessage(event) {
                if (event.data) {
                    ...
                    switch (message.action) {
                        case "contestUpdate":
                            var contest = message.data;
                            $log.info("WebSockets: Received contest " + contest.name);

                            break;

                        case "quoteUpdate":
                            var quote = message.data;
                            $log.info("WebSockets: Received quote " + quote.symbol);
                            $rootScope.FavoriteSymbols.updateQuote(quote);
                            $rootScope.HeldSecurities.updateQuote(quote);
                            $rootScope.RecentSymbols.updateQuote(quote);
                            break;
