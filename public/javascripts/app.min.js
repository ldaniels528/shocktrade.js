/**
 * ShockTrade Application Controller
...
(function() {
	...
	app.config(['$locationProvider', '$parseProvider', '$routeProvider', 
	    ...
	    $routeProvider. 
	    	...
	    	when('/play/rankings', { templateUrl: '/assets/views/play/rankings/index.htm' }).
	...
	app.run(function($rootScope, Errors, Facebook, FavoriteSymbols, HeldSecurities, MarketStatus, MySession, NewsSymbols,
					 QuoteService, RecentSymbols, WebSockets) {
