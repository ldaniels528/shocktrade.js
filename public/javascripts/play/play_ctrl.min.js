...
angular
    .module('shocktrade')
    .controller('PlayCtrl', ['$scope', '$location', '$log', 'MySession', 'ContestService', 'Errors', 'NewGameDialog', 'NewOrderDialog', 'QuoteService',
        function ($scope, $location, $log, MySession, ContestService, Errors, NewGameDialog, NewOrderDialog, QuoteService) {
            // setup UI variables
            $scope.statusBar = "";
            $scope.selection = {
                exposure: "sector",
            ...
            $scope.joinGame = function () {
                ...
                $log.info("playerInfo = " + angular.toJson(playerInfo));
            ...
            $scope.containsPlayer = function (participants, playerName) {
            ...
            $scope.joinedParticipant = function (contest, playerName) {
                return $scope.containsPlayer(contest, playerName);
            };
