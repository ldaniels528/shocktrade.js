...
angular
    .module('shocktrade')
    .controller('PlayCtrl', ['$scope', '$location', '$log', '$timeout', 'MySession', 'ContestService', 'Errors', 'NewGameDialog', 'NewOrderDialog', 'QuoteService',
        function ($scope, $location, $log, $timeout, MySession, ContestService, Errors, NewGameDialog, NewOrderDialog, QuoteService) {
            // setup UI variables
            $scope.statusBar = "";
            $scope.selection = {
                exposure: "sector",
