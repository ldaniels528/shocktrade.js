...
angular
	.module('shocktrade')
	.controller('NewsCtrl', 
		['$scope', '$cookieStore', '$log', '$sce', '$timeout', 'MySession', 'NewsService', 'NewsSymbols', 'QuoteService', 'RecentSymbols',
	     function($scope, $cookieStore, $log, $sce, $timeout, MySession, NewsService, NewsSymbols, QuoteService, RecentSymbols) {	
