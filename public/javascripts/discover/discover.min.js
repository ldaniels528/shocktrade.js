...
angular
	...
	.controller('DiscoverCtrl', 
		['$scope', '$cookieStore', '$log', '$modal', '$routeParams', '$timeout', 'Errors', 'FavoriteSymbols', 'HeldSecurities', 'MySession', 'QuoteService', 'RecentSymbols',
	    function($scope, $cookieStore, $log, $modal, $routeParams, $timeout, Errors, FavoriteSymbols, HeldSecurities, MySession, QuoteService, RecentSymbols) {		
