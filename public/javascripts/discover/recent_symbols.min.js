...
angular
	...
	loadQuotes().then(function(data) {
		//console.log("RecentSymbols: Loaded symbols for " + JSON.stringify(service.symbols));
		//console.log("RecentSymbols: Loaded quotes for " + JSON.stringify(service.quotes));
		//console.log("RecentSymbols: Quotes = " + JSON.stringify(data, null , '\t'));
	});
