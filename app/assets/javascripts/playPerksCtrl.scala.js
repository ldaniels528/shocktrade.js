angular
    .module('shocktrade')
    .controller('PerksCtrl', ['$scope', '$http', 'MySession', function($scope, $http, MySession) {
        $scope.message = null;

        $scope.perks = [
            { "code" : "CREATOR", "name" : "Game Creator", "cost" : 3, "description" : "Gives the player the ability to  create new custom games" },
            { "code" : "PRCHEMNT", "name" : "Purchase Eminent", "cost" : 3, "description" : "Gives the player the ability to create SELL orders for securities not yet owned" },
            { "code" : "PRFCTIMG", "name" : "Perfect Timing", "cost" : 4, "description" : "Gives the player the ability to create BUY orders for more than cash currently available" },
            { "code" : "CMPDDALY", "name" : "Compounded Daily", "cost" : 5, "description" : "Gives the player the ability to earn interest on cash not currently invested" },
            { "code" : "FEEWAIVR", "name" : "Fee Waiver", "cost" : 5, "description" : "Reduces the commissions the player pays for buying or selling securities" },
            { "code" : "MARGIN", "name" : "Rational People think at the Margin", "cost" : 6, "description" : "Gives the player the ability to use margin accounts" },
            { "code" : "SAVGLOAN", "name" : "Savings and Loans", "cost" : 6, "description" : "Gives the player the ability to borrow money" },
            { "code" : "LOANSHRK", "name" : "Loan Shark", "cost" : 7, "description" : "Gives the player the ability to loan other players money at any interest rate" },
            { "code" : "MUTFUNDS", "name" : "The Feeling's Mutual", "cost" : 10, "description" : "Gives the player the ability to create and use mutual funds" },
            { "code" : "RISKMGMT", "name" : "Risk Management", "cost" : 12, "description" : "Gives the player the ability to trade options" }];
