...
app = angular.module("shocktrade", ["ngCookies", "ngRoute", "ngSanitize", "ui.bootstrap"])
app.config (["$locationProvider", "$parseProvider", "$routeProvider", ($locationProvider, $parseProvider, $routeProvider) ->
    $routeProvider
...
app.run(($rootScope, Errors, Facebook, FavoriteSymbols, HeldSecurities, MarketStatus, MySession, NewsSymbols, QuoteService, RecentSymbols, WebSockets) ->
