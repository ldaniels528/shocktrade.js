 ...
 */
class PortfolioRoutes(app: Application, dbFuture: Future[Db])(implicit ec: ExecutionContext) {
  ...
  private val yfCsvQuoteSvc = new YahooFinanceCSVQuotesService()
  private val cvsParams = yfCsvQuoteSvc.getParams("symbol", "exchange", "lastTrade", "open", "close", "tradeDate", "tradeTime", "volume")
