...
CREATE TABLE newsSources (
     newsSrcID INTEGER AUTO_INCREMENT PRIMARY KEY,
     name VARCHAR(64) NOT NULL,
...
INSERT INTO newsSources (name, url, priority) VALUES ('CNN Money: Markets', 'http://rss.cnn.com/rss/money_markets.rss', 1) ;
INSERT INTO newsSources (name, url, priority) VALUES ('CNN Money: Latest News', 'http://rss.cnn.com/rss/money_latest.rss', 2);
INSERT INTO newsSources (name, url, priority) VALUES ('CBNC News', 'http://www.cnbc.com/id/100003114/device/rss/rss', 3);
INSERT INTO newsSources (name, url, priority) VALUES ('MarketWatch: Real-time Headlines', 'http://feeds.marketwatch.com/marketwatch/realtimeheadlines/', 4);
INSERT INTO newsSources (name, url, priority) VALUES ('MarketWatch: Stocks to Watch', 'http://feeds.marketwatch.com/marketwatch/StockstoWatch/', 5);
INSERT INTO newsSources (name, url, priority) VALUES ('NASDAQ Stocks News', 'http://articlefeeds.nasdaq.com/nasdaq/categories?category=Stocks', 6);
