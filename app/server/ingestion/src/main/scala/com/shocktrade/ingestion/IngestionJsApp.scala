...
object IngestionJsApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    schedule(name = "[SEC.gov]CIK Update")(initialDelay = 12.hours, frequency = 24.hours)(() => new CikUpdateDaemon().run(tradingClock))
    schedule(name = "EOD-Data Company Update")(initialDelay = 12.hours, frequency = 24.hours)(() => new EodDataCompanyUpdateDaemon().run(tradingClock))
    schedule(name = "NASDAQ Company List Update")(initialDelay = 0.hours, frequency = 24.hours)(() => new NASDAQCompanyListUpdateDaemon().run(tradingClock))
  }
