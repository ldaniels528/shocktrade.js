...
import com.shocktrade.stockguru.contest.ContestService
import com.shocktrade.stockguru.dialogs.SignUpDialog
...
object MainController {
  ...
  protected[stockguru] def getAssetCode(q: js.UndefOr[ClassifiedQuote]) = {
  ...
  protected[stockguru] def getAssetIcon(q: js.UndefOr[ClassifiedQuote]) = {
    q.flatMap(_.assetType) map {
  ...
  protected[stockguru] def normalizeExchange(aMarket: js.UndefOr[String]) = {
