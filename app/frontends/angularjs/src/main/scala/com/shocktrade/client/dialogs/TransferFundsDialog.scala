...
/**
  ...
  */
class TransferFundsDialog($uibModal: Modal) extends Service {

  /**
    * Transfer Funds pop-up dialog
    */
  def popup(): Future[TransferFundsResult] = {
    val modalInstance = $uibModal.open[TransferFundsResult](new ModalOptions(
...
/**
  ...
  * @author Lawrence Daniels <lawrence.daniels@gmail.com>
  */
class TransferFundsDialogController($scope: TransferFundsScope, $uibModalInstance: ModalInstance[TransferFundsResult], toaster: Toaster,
